...
<div class="contact-page">
        <div class="container">
            <div class="contact-page__main">
                ...
                <h3>We are always ready to answer your questions!</h3>

                <div class="contact-page__block">

                    <div class="contact-page__first">
                            <h4>Contact email: </h4>
                            <p>support@boostmysocials.ae</p>
                    </div>

                    <div class="contact-page__second">

                        <h4>Contact us in messengers: </h4>

                        <div class="contact-page__second-block1">
                            
                            <div class="contact-page__second-block2-telega">
                                <img  src="<?php bloginfo('template_url'); ?>/src/img/contact/Group-contact.svg" alt="">
                                <h5>Telegram</h5>
                            </div>

                            <img class="contact-page__second-block2-image" src="<?php bloginfo('template_url'); ?>/src/img/contact/Rectangle-contact.svg" alt="">

                            <p>@boost.my.social</p>

                        </div>

                        <div class="contact-page__second-block2">

                            <div class="contact-page__second-block2-telega">
                                <img src="<?php bloginfo('template_url'); ?>/src/img/contact/Group-contact2.svg" alt="">
                                <h5>WhatsApp</h5>
                            </div>

                            <img src="<?php bloginfo('template_url'); ?>/src/img/contact/Rectangle-contact.svg" alt="">
    ...
    <div class="follow-page">
        <div class="container">
            <div class="follow-page__main">
                <div class="follow-page__block">
                    <h3>Follow us on social media: </h3>

                    <div class="follow-page__icon">
                        <img src="<?php bloginfo('template_url'); ?>/src/img/contact/facebook.svg" alt="">
                        <a href="https://www.facebook.com"><p>Facebook</p></a>
                    </div>

                    <img src="<?php bloginfo('template_url'); ?>/src/img/contact/Rectangle 181-follow-page.svg" alt="" class="follow-page__image-mobile">

                    <div class="follow-page__icon">
                        <img src="<?php bloginfo('template_url'); ?>/src/img/contact/instagram.svg" alt="">
                        <a href="https://www.instagram.com"><p>Instagram</p></a>
                    </div>

                    <img src="<?php bloginfo('template_url'); ?>/src/img/contact/Rectangle 181-follow-page.svg" alt="" class="follow-page__image-mobile">

                    <div class="follow-page__icon" id="follow-page__icon-twitter">
                        <img src="<?php bloginfo('template_url'); ?>/src/img/contact/twitter.svg" alt="">
